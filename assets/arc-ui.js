    ...
    const paint = () => {
      ...
      nav.innerHTML = `
        <a class="nav-logo" href="/">
          <img class="logo-img logo-on-dark" src="/assets/logos/wordmark-oneliq.png" alt="Oneliq" height="34"/><img class="logo-img logo-on-light" style="display:none" src="/assets/logos/wordmark-oneliq-light.png" alt="" aria-hidden="true" height="34"/>
        </a>
        <div class="nav-tabs">
      ...
      side.innerHTML = `
        <div class="arc-side-head">
          <a class="arc-side-brand" href="/" aria-label="Oneliq home">
            <img class="arc-side-logo logo-on-dark" src="/assets/logos/wordmark-oneliq.png" alt="Oneliq" height="38"/><img class="arc-side-logo logo-on-light" style="display:none" src="/assets/logos/wordmark-oneliq-light.png" alt="" aria-hidden="true" height="38"/>
          </a>
